...
import 'package:sakny/presentation/onboarding_screen/onboarding_screen.dart';
import 'package:sakny/presentation/splash_screen/splash_screen.dart';
import 'package:sakny/presentation/sign_in_screen/sign_in_screen.dart';
import 'package:sakny/presentation/sign_up_screen/sign_up_screen.dart';
import 'package:sakny/presentation/home_container_screen/home_container_screen.dart';
import 'package:sakny/presentation/home_alarm_screen/home_alarm_screen.dart';
import 'package:sakny/presentation/notification_screen/notification_screen.dart';
import 'package:sakny/presentation/notification_empty_states_screen/notification_empty_states_screen.dart';
import 'package:sakny/presentation/message_chat_screen/message_chat_screen.dart';
import 'package:sakny/presentation/my_home_empty_screen/my_home_empty_screen.dart';
import 'package:sakny/presentation/add_new_property_address_screen/add_new_property_address_screen.dart';
import 'package:sakny/presentation/add_new_property_meet_with_a_agent_screen/add_new_property_meet_with_a_agent_screen.dart';
import 'package:sakny/presentation/add_new_property_time_to_sell_screen/add_new_property_time_to_sell_screen.dart';
import 'package:sakny/presentation/add_new_property_reason_selling_home_screen/add_new_property_reason_selling_home_screen.dart';
import 'package:sakny/presentation/add_new_property_decsription_screen/add_new_property_decsription_screen.dart';
import 'package:sakny/presentation/add_new_property_home_facts_screen/add_new_property_home_facts_screen.dart';
import 'package:sakny/presentation/add_new_property_contact_screen/add_new_property_contact_screen.dart';
import 'package:sakny/presentation/add_new_property_select_amenities_screen/add_new_property_select_amenities_screen.dart';
import 'package:sakny/presentation/add_new_property_details_screen/add_new_property_details_screen.dart';
import 'package:sakny/presentation/home_listing_screen/home_listing_screen.dart';
import 'package:sakny/presentation/home_listing_satelite_screen/home_listing_satelite_screen.dart';
import 'package:sakny/presentation/home_listing_draw_screen/home_listing_draw_screen.dart';
import 'package:sakny/presentation/filter_screen/filter_screen.dart';
import 'package:sakny/presentation/product_details_screen/product_details_screen.dart';
import 'package:sakny/presentation/pick_date_screen/pick_date_screen.dart';
import 'package:sakny/presentation/verify_phone_number_screen/verify_phone_number_screen.dart';
import 'package:sakny/presentation/select_virtual_app_screen/select_virtual_app_screen.dart';
import 'package:sakny/presentation/select_app_alarm_screen/select_app_alarm_screen.dart';
import 'package:sakny/presentation/confirm_request_screen/confirm_request_screen.dart';
import 'package:sakny/presentation/settings_screen/settings_screen.dart';
import 'package:sakny/presentation/faqs_get_help_screen/faqs_get_help_screen.dart';
import 'package:sakny/presentation/past_tours_screen/past_tours_screen.dart';
import 'package:sakny/presentation/edit_profile_screen/edit_profile_screen.dart';
import 'package:sakny/presentation/recently_views_screen/recently_views_screen.dart';
import 'package:sakny/presentation/favorite_screen/favorite_screen.dart';
import 'package:sakny/presentation/app_navigation_screen/app_navigation_screen.dart';
